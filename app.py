...
def main():
    ...
    with tab3:
        ...
        sample_data.boxplot(column='transaction_amount', by='is_fraud', ax=ax1)
        ...
        fraud_by_hour = sample_data[sample_data['is_fraud']].groupby('hour').size()
        fig2, ax2 = plt.subplots(figsize=(10, 5))
        fraud_by_hour.plot(kind='bar', ax=ax2)
        ax2.set_title("Fraud Counts by Hour")
